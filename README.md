...
| Learning Functions（教材機能） | 解説教材・移行テンプレート・設計ドキュメント標準の7ファイル構成テンプレート・自己帰属バイアス（簡易版／詳細版）を、Level別に提供する。 | [L1](./01_ai_basics/README.md) / [L2](./02_design_document_basics/README.md) |
