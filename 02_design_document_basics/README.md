...
- `[補助資料]` [Markdownの基本](./markdown_basic.md)

Markdownは設計そのものではない。READMEや設計書をMarkdownで記述する必要がある場合に参照する補助資料とする。
...
Markdown記法が必要な場合だけ `[補助資料] Markdownの基本` を参照する。
...
解説用の学習用資料5点、補助資料1点、設計テンプレート7ファイルを維持する。
