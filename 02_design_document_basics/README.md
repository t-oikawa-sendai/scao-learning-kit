...
ポートフォリオや小規模アプリを作る前に整理すべき設計ドキュメントの基本を身につける。README、要求、要件、簡易設計、ドキュメント管理を理解し、生成AIへ実装を指示する前の土台を作る。
...
要求（何を達成したいか）→ 要件（システムが満たすべき条件）→ 簡易設計（どう作るか）の順で整理すると、生成AIに実装を指示する前の土台が固まる。READMEとドキュメント管理は、これらを整理・公開するための土台になる。各解説を読んだうえで、対応するテンプレートをコピーして使う。
