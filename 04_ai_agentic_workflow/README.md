...
| Related Documents（関連文書） | [トップ](../README.md) / [L1：生成AI利用の基本](../01_ai_basics/README.md) |
...
AIエージェントを、人間の確認を挟みながら安全に活用できるように導くこと。

## 2. Target Audience（対象読者）

- L1（特に生成AIの自己正当化バイアス）を踏まえ、AIエージェントの半自動ループを安全に組みたい人

## 3. Learning Materials Index（学習用資料一覧）

この領域は準備中のため、学習用資料はまだ作成していない。今後、次の対象を扱う予定（名称のみを示し、本文説明はまだ作成していない）。
...
準備中。公開後に利用方法を記載する。現時点では [L1：生成AI利用の基本](../01_ai_basics/README.md) の [生成AIの自己正当化バイアス 詳細編](../01_ai_basics/self_justification_bias_detail.md) を参照し、同じ生成AIに作成と最終判定を独占させない考え方を確認することを推奨する。
...
- [トップに戻る](../README.md)
- [L1：生成AI利用の基本](../01_ai_basics/README.md)
